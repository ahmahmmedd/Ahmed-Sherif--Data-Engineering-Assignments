...
attendance_df['Clock_out'] = attendance_df['Clock_out'].fillna(pd.NaT)
...
frequent_absentees = summary[summary['days_worked'] < summary['days_worked'].max() - 1]
...
Frequent Absentees (worked at least 2 days less than top performer):
